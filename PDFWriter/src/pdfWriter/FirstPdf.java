...
public class FirstPdf {
	...
	public static void main(String[] args) {
		try {
			...
			PdfWriter.getInstance(document, new FileOutputStream(getSavePath()));
			document.open();
	...
	// iText allows to add metadata to the PDF which can be viewed in your Adobe
	  ...
	  private static void addMetaData(Document document) {
	    ...
	    document.addSubject(JOptionPane.showInputDialog("Enter the subject"));
	  ...
	  private static void addTitlePage(Document document)
	    ...
	    preface.add(new Paragraph(message,
	        smallBold));

	    addEmptyLine(preface, 8);

	    preface.add(new Paragraph("This document is a preliminary version and is currently in beta.",
	        redFont));
